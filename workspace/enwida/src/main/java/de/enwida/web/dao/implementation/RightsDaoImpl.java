...
public class RightsDaoImpl extends AbstractBaseDao<Right> implements IRightsDao {
    ...
    public boolean isAuthorizedByExample(DataAuthorization dataAuthorization) {
        String SELECT_QUERY = "SELECT COUNT(*) FROM users.rights WHERE role = ? AND tso = ? AND product = ? AND aspect SIMILAR TO ? AND resolution SIMILAR TO ? AND time_from >= ? AND time_to <= ? AND enabled = ?;";
    ...
    public DataAuthorization getByExample(DataAuthorization dataAuthorization) {
        String SELECT_QUERY = "SELECT * FROM users.rights WHERE role = ? AND tso = ? AND product = ? AND aspect SIMILAR TO ? AND resolution SIMILAR TO ? AND time_from >= ? AND time_to <= ? AND enabled = ?;";
    ...
    public List<DataAuthorization> getListByExample(DataAuthorization dataAuthorization) {
        String SELECT_QUERY = "SELECT * FROM users.rights WHERE role = ? AND tso = ? AND product = ? AND aspect SIMILAR TO ? AND enabled = ?;";
    ...
    public void enableLine(DataAuthorization dataAuthorization) {
        String UPDATET_QUERY = "UPDATE users.rights SET enabled = ? WHERE role = ? AND tso = ? AND product = ? AND aspect SIMILAR TO ?;";
